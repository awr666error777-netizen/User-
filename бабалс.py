...
PHONE = os.environ.get('+14094403493')

supabase = create_client(
    os.environ.get('https://ydpiqaxlqhjarifyvtvt.supabase.co'),
    os.environ.get('eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlkcGlxYXhscWhqYXJpZnl2dHZ0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Nzc0ODU3NzUsImV4cCI6MjA5MzA2MTc3NX0.rvcBWzFqb2bitK0mwgggSiG2CgsMJQZ2ATiQtSUC210')
)
groq_client = Groq(api_key=os.environ.get(''))
